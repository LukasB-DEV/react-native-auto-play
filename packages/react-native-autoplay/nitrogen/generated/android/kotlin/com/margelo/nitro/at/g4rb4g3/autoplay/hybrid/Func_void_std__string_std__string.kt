...
/**
 * Represents the JavaScript callback `(tripId: string, routeId: string) => void`.
...
fun interface Func_void_std__string_std__string: (String, String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(tripId: String, routeId: String): Unit
}
...
class Func_void_std__string_std__string_cxx: Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(tripId: String, routeId: String): Unit
    = invoke_cxx(tripId,routeId)

  @FastNative
  private external fun invoke_cxx(tripId: String, routeId: String): Unit
}
...
class Func_void_std__string_std__string_java(private val function: (String, String) -> Unit): Func_void_std__string_std__string {
  ...
  @Keep
  override fun invoke(tripId: String, routeId: String): Unit {
    return this.function(tripId, routeId)
  }
}
