...
/**
 * Represents the JavaScript callback `(searchText: string) => void`.
...
fun interface Func_void_std__string: (String) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(searchText: String): Unit
}
...
class Func_void_std__string_cxx: Func_void_std__string {
  ...
  @Keep
  override fun invoke(searchText: String): Unit
    = invoke_cxx(searchText)

  @FastNative
  private external fun invoke_cxx(searchText: String): Unit
}
...
class Func_void_std__string_java(private val function: (String) -> Unit): Func_void_std__string {
  ...
  @Keep
  override fun invoke(searchText: String): Unit {
    return this.function(searchText)
  }
}
