...
/**
 * Represents the JavaScript callback `(clusterId: string, payload: boolean) => void`.
...
fun interface Func_void_std__string_bool: (String, Boolean) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(clusterId: String, payload: Boolean): Unit
}
...
class Func_void_std__string_bool_cxx: Func_void_std__string_bool {
  ...
  @FastNative
  private external fun invoke_cxx(clusterId: String, payload: Boolean): Unit
}
