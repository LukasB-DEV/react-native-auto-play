///
/// JNitroBaseMapTemplateConfig.hpp
...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NitroBaseMapTemplateConfig" and the the Kotlin data class "NitroBaseMapTemplateConfig".
   */
  struct JNitroBaseMapTemplateConfig final: public jni::JavaClass<JNitroBaseMapTemplateConfig> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/at/g4rb4g3/autoplay/hybrid/NitroBaseMapTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NitroBaseMapTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NitroBaseMapTemplateConfig toCpp() const {
