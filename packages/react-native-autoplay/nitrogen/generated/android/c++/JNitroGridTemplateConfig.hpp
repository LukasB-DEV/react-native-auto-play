...
namespace margelo::nitro::at::g4rb4g3::autoplay {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "NitroGridTemplateConfig" and the the Kotlin data class "NitroGridTemplateConfig".
   */
  struct JNitroGridTemplateConfig final: public jni::JavaClass<JNitroGridTemplateConfig> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/at/g4rb4g3/autoplay/NitroGridTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct NitroGridTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    NitroGridTemplateConfig toCpp() const {
      ...
      return NitroGridTemplateConfig(
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JNitroGridTemplateConfig::javaobject> fromCpp(const NitroGridTemplateConfig& value) {
      return newInstance(
