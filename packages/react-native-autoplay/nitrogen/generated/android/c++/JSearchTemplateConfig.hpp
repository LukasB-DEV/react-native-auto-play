...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/at/g4rb4g3/autoplay/hybrid/SearchTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct SearchTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    SearchTemplateConfig toCpp() const {
      ...
      jni::local_ref<JFunc_void_std__string::javaobject> onSearchTextChanged = this->getFieldValue(fieldOnSearchTextChanged);
      static const auto fieldOnSearchTextSubmitted = clazz->getField<JFunc_void_std__string::javaobject>("onSearchTextSubmitted");
      jni::local_ref<JFunc_void_std__string::javaobject> onSearchTextSubmitted = this->getFieldValue(fieldOnSearchTextSubmitted);
      return SearchTemplateConfig(
        ...
        [&]() -> std::function<void(const std::string& /* searchText */)> {
          if (onSearchTextChanged->isInstanceOf(JFunc_void_std__string_cxx::javaClassStatic())) [[likely]] {
            auto downcast = jni::static_ref_cast<JFunc_void_std__string_cxx::javaobject>(onSearchTextChanged);
            return downcast->cthis()->getFunction();
          } else {
  ...
  public:
    ...
    static jni::local_ref<JSearchTemplateConfig::javaobject> fromCpp(const SearchTemplateConfig& value) {
      using JSignature = JSearchTemplateConfig(jni::alias_ref<jni::JString>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void::javaobject>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JArrayClass<JNitroAction>>, jni::alias_ref<JAutoText>, jni::alias_ref<JNitroSection>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<JFunc_void_std__string::javaobject>, jni::alias_ref<JFunc_void_std__string::javaobject>);
      static const auto clazz = javaClassStatic();
