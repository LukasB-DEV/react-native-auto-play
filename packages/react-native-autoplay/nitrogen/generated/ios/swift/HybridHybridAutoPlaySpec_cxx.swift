...
open class HybridHybridAutoPlaySpec_cxx {
  ...
  @inline(__always)
  public final func presentTemplate(templateId: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.presentTemplate(templateId: String(templateId))
