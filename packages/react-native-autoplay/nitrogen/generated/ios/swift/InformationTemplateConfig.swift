///
/// InformationTemplateConfig.swift
...
public extension InformationTemplateConfig {
   ...
   */
  init(id: String, onWillAppear: ((_ animated: Bool?) -> Void)?, onWillDisappear: ((_ animated: Bool?) -> Void)?, onDidAppear: ((_ animated: Bool?) -> Void)?, onDidDisappear: ((_ animated: Bool?) -> Void)?, onPopped: (() -> Void)?, headerActions: [NitroAction]?, title: AutoText, section: NitroSection?, mapConfig: NitroBaseMapTemplateConfig?) {
