...
public final class Func_void_std__string_bool {
  ...
  private let closure: (_ clusterId: String, _ payload: Bool) -> Void

  public init(_ closure: @escaping (_ clusterId: String, _ payload: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(clusterId: std.string, payload: Bool) -> Void {
    self.closure(String(clusterId), payload)
  }
