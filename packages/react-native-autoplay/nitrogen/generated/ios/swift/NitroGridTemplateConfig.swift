...
/**
 * Represents an instance of `NitroGridTemplateConfig`, backed by a C++ struct.
 */
public typealias NitroGridTemplateConfig = margelo.nitro.at.g4rb4g3.autoplay.NitroGridTemplateConfig

public extension NitroGridTemplateConfig {
  private typealias bridge = margelo.nitro.at.g4rb4g3.autoplay.bridge.swift

  /**
   * Create a new instance of `NitroGridTemplateConfig`.
   */
  init(actions: [NitroAction]?, title: AutoText, buttons: [NitroGridButton], id: String, onWillAppear: ((_ animated: Bool?) -> Void)?, onWillDisappear: ((_ animated: Bool?) -> Void)?, onDidAppear: ((_ animated: Bool?) -> Void)?, onDidDisappear: ((_ animated: Bool?) -> Void)?, onPoppedToRoot: ((_ animated: Bool?) -> Void)?) {
