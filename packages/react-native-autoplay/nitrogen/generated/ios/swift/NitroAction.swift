...
public extension NitroAction {
   ...
   */
  init(title: String?, image: Variant_GlyphImage_AssetImage?, enabled: Bool?, onPress: @escaping () -> Void, type: NitroActionType, alignment: NitroAlignment?, flags: Double?, style: AlertActionStyle?) {
