...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid::bridge::swift {
  ...
  Func_void_Point_double create_Func_void_Point_double(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroAutoplay::Func_void_Point_double::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_AutoText_std__optional_AutoText_ create_Func_void_AutoText_std__optional_AutoText_(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = NitroAutoplay::Func_void_AutoText_std__optional_AutoText_::fromUnsafe(swiftClosureWrapper);
