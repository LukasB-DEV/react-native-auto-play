...
namespace margelo::nitro::at::g4rb4g3::autoplay {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroGridTemplateConfig).
   */
  struct NitroGridTemplateConfig {
  public:
  ...
  public:
    NitroGridTemplateConfig() = default;
    explicit NitroGridTemplateConfig(std::optional<std::vector<NitroAction>> actions, AutoText title, std::vector<NitroGridButton> buttons, std::string id, std::optional<std::function<void(std::optional<bool> /* animated */)>> onWillAppear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onWillDisappear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onDidAppear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onDidDisappear, std::optional<std::function<void(std::optional<bool> /* animated */)>> onPoppedToRoot): actions(actions), title(title), buttons(buttons), id(id), onWillAppear(onWillAppear), onWillDisappear(onWillDisappear), onDidAppear(onDidAppear), onDidDisappear(onDidDisappear), onPoppedToRoot(onPoppedToRoot) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ NitroGridTemplateConfig <> JS NitroGridTemplateConfig (object)
  template <>
  struct JSIConverter<margelo::nitro::at::g4rb4g3::autoplay::NitroGridTemplateConfig> final {
    static inline margelo::nitro::at::g4rb4g3::autoplay::NitroGridTemplateConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::at::g4rb4g3::autoplay::NitroGridTemplateConfig(
        ...
        JSIConverter<std::vector<margelo::nitro::at::g4rb4g3::autoplay::NitroGridButton>>::fromJSI(runtime, obj.getProperty(runtime, "buttons")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::at::g4rb4g3::autoplay::NitroGridTemplateConfig& arg) {
      ...
      obj.setProperty(runtime, "buttons", JSIConverter<std::vector<margelo::nitro::at::g4rb4g3::autoplay::NitroGridButton>>::toJSI(runtime, arg.buttons));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::vector<margelo::nitro::at::g4rb4g3::autoplay::NitroGridButton>>::canConvert(runtime, obj.getProperty(runtime, "buttons"))) return false;
