...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
  ...
  enum class TurnType {
    ...
    SLIGHTLEFT      SWIFT_NAME(slightleft) = 1,
    SLIGHTRIGHT      SWIFT_NAME(slightright) = 2,
    NORMALLEFT      SWIFT_NAME(normalleft) = 3,
    NORMALRIGHT      SWIFT_NAME(normalright) = 4,
    SHARPLEFT      SWIFT_NAME(sharpleft) = 5,
    SHARPRIGHT      SWIFT_NAME(sharpright) = 6,
    UTURNLEFT      SWIFT_NAME(uturnleft) = 7,
