...
namespace margelo::nitro::at::g4rb4g3::autoplay::hybrid {
   ...
   */
  struct TripSelectorCallback {
  public:
    std::function<void(const std::string& /* id */)> setSelectedTrip     SWIFT_PRIVATE;

  public:
    TripSelectorCallback() = default;
...
namespace margelo::nitro {
  ...
  struct JSIConverter<margelo::nitro::at::g4rb4g3::autoplay::hybrid::TripSelectorCallback> final {
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::function<void(const std::string&)>>::canConvert(runtime, obj.getProperty(runtime, "setSelectedTrip"))) return false;
      return true;
    }
  };
