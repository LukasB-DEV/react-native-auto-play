...
namespace margelo::nitro {
  ...
  struct JSIConverter<margelo::nitro::at::g4rb4g3::autoplay::hybrid::NitroColor> final {
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, "lightColor"))) return false;
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, "darkColor"))) return false;
      return true;
    }
  };
